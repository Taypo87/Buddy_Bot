...
#include "move_bot/msg/detail/movement__rosidl_typesupport_fastrtps_c.h"
...
#include "move_bot/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Movement__ros_msg_type = move_bot__msg__Movement;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_move_bot
size_t get_serialized_size_move_bot__msg__Movement(
  const void * untyped_ros_message,
...
static uint32_t _Movement__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_move_bot__msg__Movement(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_move_bot
size_t max_serialized_size_move_bot__msg__Movement(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = move_bot__msg__Movement;
    is_plain =
      (
...
static size_t _Movement__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_move_bot__msg__Movement(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, move_bot, msg, Movement)() {
