...
bool move_bot__msg__movement__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("move_bot.msg._movement.Movement", full_classname_dest, 31) == 0);
  }
  move_bot__msg__Movement * ros_message = _ros_message;
  {  // command
...
PyObject * move_bot__msg__movement__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("move_bot.msg._movement");
